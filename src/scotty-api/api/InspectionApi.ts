...
export class InspectionApi {
    ...
    /**
     * create inspection
     * @param createInspection single inspection record
     */
    public createInspection(createInspection?: models.CreateInspection, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: number;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/inspection';
        ...
        requestOptions.data = JSON.stringify(createInspection);
     ...
     */
    public deleteInspection(id: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: number;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/inspection/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));

        let queryParameters: any = {};
        let headerParams: any = {};
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteInspection.');
        }
     ...
     * @param id primary key value
     * @param incrementInspection single inspection record
     */
    public incrementInspection(id: string, incrementInspection?: models.IncrementInspection, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: number;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/inspection/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling incrementInspection.');
        }
        ...
        requestOptions.data = JSON.stringify(incrementInspection);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
    ...
    > {
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.ListInspection, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     * @param join Paths (comma separated) to related entities that you want to include. Example: comments,users
     */
    public readInspection(id: string, include?: string, exclude?: string, join?: Array<string>, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.ReadInspection;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/inspection/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling readInspection.');
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.ReadInspection, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     * update inspection
     * @param id primary key value
     * @param updateInspection single inspection record
     */
    public updateInspection(id: string, updateInspection?: models.UpdateInspection, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: number;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/inspection/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updateInspection.');
        }
        ...
        requestOptions.data = JSON.stringify(updateInspection);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
