...
export class UserApi {
    ...
    /**
     * create user
     * @param createUser single user record
     */
    public createUser(createUser?: models.CreateUser, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: number;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/user';
        ...
        requestOptions.data = JSON.stringify(createUser);
     ...
     */
    public deleteUser(id: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: number;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/user/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     * increment user
     * @param id primary key value
     * @param incrementUser single user record
     */
    public incrementUser(id: string, incrementUser?: models.IncrementUser, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: number;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/user/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling incrementUser.');
        }
        ...
        requestOptions.data = JSON.stringify(incrementUser);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
     ...
     */
    public listUser(filter?: Array<string>, filter1?: Array<string>, filter2?: Array<string>, filter3?: Array<string>, include?: string, exclude?: string, order?: Array<string>, size?: string, page?: string, join?: Array<string>, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.ListUser;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/user';
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.ListUser, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     * @param join Paths (comma separated) to related entities that you want to include. Example: comments,users
     */
    public readUser(id: string, include?: string, exclude?: string, join?: Array<string>, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.ReadUser;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/user/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling readUser.');
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.ReadUser, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     * update user
     * @param id primary key value
     * @param updateUser single user record
     */
    public updateUser(id: string, updateUser?: models.UpdateUser, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: number;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/records/user/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        requestOptions.data = JSON.stringify(updateUser);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
